...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-500">
            Período: {dashboard.period.days} dias ({formatDate(dashboard.period.start_date)} - {formatDate(dashboard.period.end_date)})
          </p>
        </div>
        ...
        <div className="rounded-lg border-l-4 border-blue-500 bg-white p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-900">{formatPoints(dashboard.points.current_balance)}</p>
              {dashboard.points.pending > 0 && (
        ...
        <div className="rounded-lg border-l-4 border-green-500 bg-white p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-900">{dashboard.purchases.total_count}</p>
              <p className="mt-1 text-sm text-gray-600">
                {formatCurrency(dashboard.purchases.total_amount)} gastos
              </p>
            </div>
        ...
        <div className="rounded-lg border-l-4 border-purple-500 bg-white p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-900">{dashboard.transfers.total_count}</p>
              <p className="mt-1 text-sm text-gray-600">
                {formatPoints(Math.abs(dashboard.transfers.net_points))} {dashboard.transfers.net_points >= 0 ? "recebidos" : "enviados"}
              </p>
            </div>
        ...
        <div className="rounded-lg border-l-4 border-yellow-500 bg-white p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-900">{dashboard.friends.total}</p>
              {dashboard.friends.new_in_period > 0 && (
        ...
        <div className="rounded-lg bg-white p-6 shadow-md">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              ...
              <span className="font-semibold text-green-600">{formatPoints(dashboard.points.period.earned)}</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              <span className="text-gray-600">Gastos no Período</span>
              <span className="font-semibold text-red-600">{formatPoints(dashboard.points.period.spent)}</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              <span className="text-gray-600">Líquido no Período</span>
              <span className="font-semibold text-blue-600">{formatPoints(dashboard.points.period.net)}</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              <span className="text-gray-600">Total de Transações</span>
              <span className="font-semibold text-gray-900">{dashboard.points.period.transactions}</span>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-gray-600">Saldo Disponível</span>
              <span className="text-lg font-semibold text-gray-900">{formatPoints(dashboard.points.current_balance)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg bg-white p-6 shadow-md">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              ...
              <span className="font-semibold text-green-600">{dashboard.purchases.confirmed_count}</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              <span className="text-gray-600">Pendentes</span>
              <span className="font-semibold text-yellow-600">{dashboard.purchases.pending_count}</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              <span className="text-gray-600">Rejeitadas</span>
              <span className="font-semibold text-red-600">{dashboard.purchases.rejected_count}</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              <span className="text-gray-600">Valor Total Confirmado</span>
              <span className="font-semibold text-gray-900">{formatCurrency(dashboard.purchases.confirmed_amount)}</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-2">
              <span className="text-gray-600">Pontos Ganhos</span>
              <span className="font-semibold text-blue-600">{formatPoints(dashboard.purchases.confirmed_points_earned)}</span>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-gray-600">Média por Compra</span>
              <span className="font-semibold text-gray-900">{formatCurrency(dashboard.purchases.avg_amount)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Top Rankings */}
      {(dashboard.purchases.top_establishments?.length > 0 || dashboard.transfers.top_friends?.length > 0) && (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          {/* Top Estabelecimentos */}
